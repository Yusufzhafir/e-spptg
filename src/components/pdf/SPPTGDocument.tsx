 ...
 * 
 * This is the main document component that combines all three pages
 ...
 * 
 * Renders a complete 3-page SPPTG document with all sections.
 * The document includes:
 * - Page 1: Personal info, land details, statements 1-3
 * - Page 2: Statements 4-5, witnesses table, signatures
